...
var page8 = page_starter + 
        ...
        ' style="max-height: 100%; width: auto;"> </img> </div>' +
        '<p> The player picks the blue path, and you can now' +
        ' watch what happens. </p>';

var page9 = page_starter +
        '<h2> Example </h2> <img src="trials/example/02.png"' +
        ' style="max-height: 100%; width: auto;"> </img> </div>' +
        '<p> The player takes a step right and now faces a' +
        ' closed door. </p>';
...
var instructions_path = '<b><span style="color:rgb(140, 205, 255)";>blue</span></b>';
...
var instruction_pages1 = instruction_pages.slice(0, 7);
var instruction_pages2 = instruction_pages.slice(7);
...
var instructions_last = '<p> In this experiment, we will show you scenarios' +
        ...
        ' Before the round starts, we want to know how likely you think the' +
        ' player would win if they were to take one of the paths. After' +
        ' you answer, you will be able to watch what actually happened. </p>';

var start_prompt1 = '<p> Correct! You will now watch the player for 18 rounds. </p>' +
        '<p> On each round, first you will answer the question. Then, you will' +
        ' get to watch a step-by-step play of what actually happened, just' +
        ' like in the example. You can proceed by' +
        ' either clicking the buttons or pressing arrow keys. </p>';
