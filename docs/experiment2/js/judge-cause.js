/**
 * a jspsych plugin for causal judgment slider question
 *
 */


jsPsych.plugins['judge-cause'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div style="width: 100%;" class="jspsych-html-slider-response-response slider-agreement"></div>';
    html += '<div>'
